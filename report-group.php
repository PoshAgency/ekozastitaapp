												...
												<table class="w-full">
													...
													<tbody>
														...
														<tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
															...
															<td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
																<a href="report-full.php"><i class="icofont-billboard text-lg text-gray-500 dark:text-gray-400"></i></a>
																<a href="javascript:;"><i class="icofont-paper-plane text-lg text-gray-500 dark:text-gray-400"></i></a>
																<a href="report-full-edit.php"><i class="icofont-ui-edit text-lg text-gray-500 dark:text-gray-400"></i></a>
